      ...
      return (
        <>
          ...
          <div className="col-lg-8 offset-lg-3 verticalUpper">
            ...
            <p className="text-white">
              Unforturnately, Test-Ware trainer is optimised for screens with an
              area larger than {config.MIN_WINDOW_AREA}px^2.
            </p>
            <p className="text-white">
        ...
        return (
          <>
            ...
            <div className="col-lg-8 offset-lg-3 verticalUpper widthWide">
              ...
              <br />
              <p className="text-white">
                During the <b>{duration}</b> year period, you've made a gain of{" "}
                <b>{gain}</b>.
              </p>
              <p className="text-white">
